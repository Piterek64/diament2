...
import 'innyczaskuriergodzina_model.dart';
export 'innyczaskuriergodzina_model.dart';

class InnyczaskuriergodzinaWidget extends StatefulWidget {
  const InnyczaskuriergodzinaWidget({super.key});

  @override
  State<InnyczaskuriergodzinaWidget> createState() =>
      _InnyczaskuriergodzinaWidgetState();
}

class _InnyczaskuriergodzinaWidgetState
    extends State<InnyczaskuriergodzinaWidget> {
  late InnyczaskuriergodzinaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InnyczaskuriergodzinaModel());
                  ...
                  await FFAppState()
                      ...
                      .update(createZamowienieRecordData(
                        ...
                        godzinanagodzinekurier:
                            _model.innyczasgodzinakurierTextController.text,
                        przyjete: true,
                        dostarczone: false,
                      ));
            ...
            Align(
              ...
              child: Padding(
                ...
                child: SizedBox(
                  ...
                  child: TextFormField(
                    controller: _model.innyczasgodzinakurierTextController,
