...
import '/components/daty_widget.dart';
import '/flutter_flow/flutter_flow_theme.dart';
import '/flutter_flow/flutter_flow_util.dart';
import '/flutter_flow/flutter_flow_widgets.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'mojestatystyki_model.dart';
export 'mojestatystyki_model.dart';

class MojestatystykiWidget extends StatefulWidget {
  const MojestatystykiWidget({super.key});

  @override
  State<MojestatystykiWidget> createState() => _MojestatystykiWidgetState();
}

class _MojestatystykiWidgetState extends State<MojestatystykiWidget> {
  late MojestatystykiModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MojestatystykiModel());
  }
                            ...
                            () {
                              if (FFAppState().POJDATA) {
                                return dateTimeFormat(
                                    'd/M/y', FFAppState().tymDate);
                              } else if (FFAppState().ZAKRESDAT) {
                                return 'Od ${dateTimeFormat('d/M/y', FFAppState().startDate)} do ${dateTimeFormat('d/M/y', FFAppState().endDate)}';
                              } else {
                                return 'Brak daty';
                              }
                            }(),
