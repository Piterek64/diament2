...
import 'innyczasrestauracjagodzina_copy_model.dart';
export 'innyczasrestauracjagodzina_copy_model.dart';

class InnyczasrestauracjagodzinaCopyWidget extends StatefulWidget {
  const InnyczasrestauracjagodzinaCopyWidget({super.key});

  @override
  State<InnyczasrestauracjagodzinaCopyWidget> createState() =>
      _InnyczasrestauracjagodzinaCopyWidgetState();
}

class _InnyczasrestauracjagodzinaCopyWidgetState
    extends State<InnyczasrestauracjagodzinaCopyWidget> {
  late InnyczasrestauracjagodzinaCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InnyczasrestauracjagodzinaCopyModel());
                  ...
                  child: TextFormField(
                    ...
                    onFieldSubmitted: (_) async {
                      FFAppState().tymczasowyczas =
                          int.parse(_model.innyczasgodzinaTextController.text);
                      setState(() {});
                      await showModalBottomSheet(
                        isScrollControlled: true,
                        backgroundColor: Colors.transparent,
