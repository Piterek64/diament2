...
import 'innyczasrestauracja_model.dart';
export 'innyczasrestauracja_model.dart';

class InnyczasrestauracjaWidget extends StatefulWidget {
  const InnyczasrestauracjaWidget({super.key});

  @override
  State<InnyczasrestauracjaWidget> createState() =>
      _InnyczasrestauracjaWidgetState();
}

class _InnyczasrestauracjaWidgetState extends State<InnyczasrestauracjaWidget> {
  late InnyczasrestauracjaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InnyczasrestauracjaModel());
